...
function formaterPublication(listeMatchs) {
  // 1. Obtenir l'heure complète de Brazzaville (Nouveau format demandé !)
  const heureComplete = new Date().toLocaleString('fr-FR', { timeZone: 'Africa/Brazzaville' });
  let texte = `⚽ VOLTIXAI LIVE ⚫ Mise à jour : ${heureComplete}\n========================================\n\n`;
